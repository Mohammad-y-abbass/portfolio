                ...
                >
                    ...
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-2 md:gap-3">
                            ...
                            <span className="text-mono text-[#737373]">skills</span>
                        </div>
                            ...
                            <motion.div key={skillGroup.category} variants={itemVariants}>
                                <div className="group relative">
                                    <div className="flex flex-col gap-3 md:gap-4">
                                        <div className="flex items-center gap-2 md:gap-3">
                                            <div className="w-2 h-2 md:w-2.5 md:h-2.5 border border-[#404040] rounded-full group-hover:bg-[#404040] transition-colors duration-300" />
                                            <h3 className="text-large font-normal text-[#fafafa]">{skillGroup.category}</h3>
                                        </div>
                                        ...
                                        <div className="flex flex-wrap gap-2 md:gap-3 ml-5 md:ml-6">
                                            {skillGroup.items.map((skill) => (
                                                <span
                                                    key={skill}
                                                    className="px-3 py-1.5 md:px-4 md:py-2 text-base text-[#a1a1a1] bg-[#0a0a0a] border border-[#1a1a1a] rounded-md hover:border-[#404040] hover:text-[#fafafa] transition-all duration-300"
                                                >
                                                    {skill}
                                                </span>
                                            ))}
